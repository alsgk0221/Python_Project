...
def strip_optimizer(f='yolo_best.pt', s=''):  # from utils.general import *; strip_optimizer()
...
def save_one_box(xyxy, im, file='./clothes.jpg', gain=1.02, pad=10, square=False, BGR=False, save=True):
